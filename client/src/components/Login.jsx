...
const Login = () => {
  ...
  return (
    <div className="min-h-screen animated-gradient relative overflow-hidden flex items-center justify-center p-4">
      ...
      <div className="absolute bottom-1/4 right-1/4 w-96 h-96 bg-primary-600/20 rounded-full blur-3xl animate-pulse-slow" style={{ animationDelay: '2s' }} />
      ...
      <div className="glass-card w-full max-w-md p-8 relative z-10 animate-slide-up">
        ...
        <div className="text-center mb-8">
          ...
          <p className="text-dark-300">Welcome back! Sign in to continue</p>
        </div>
        ...
        <div className="mt-8 text-center">
          <p className="text-dark-400">
            ...
            <Link to="/signup" className="text-neon-blue hover:text-primary-400 font-medium transition-colors">
              Create Account
            </Link>
          </p>
        </div>
